...
export function createTranslator(
	locale: Accessor<Locale | string | undefined>,
) {
	const fallbackDictionary = flatten(
		dictionaries.en,
	) as unknown as FlatDictionary;
...
export function I18nProvider(props: I18nProviderProps) {
	const currentLocale = createMemo<Locale>(() =>
		toSupportedLocale(props.locale()),
	);
