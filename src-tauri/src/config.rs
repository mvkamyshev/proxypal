...
pub struct AppConfig {
    ...
    #[serde(default = "default_codex_warmup_enabled")]
    pub codex_warmup_enabled: bool,
    #[serde(default = "default_codex_warmup_time")]
    pub codex_warmup_time: String,
}
...
fn default_codex_warmup_enabled() -> bool {
    true
}

fn default_codex_warmup_time() -> String {
    "12:00".to_string()
}
...
impl Default for AppConfig {
    fn default() -> Self {
        Self {
            ...
            codex_warmup_enabled: true,
            codex_warmup_time: "12:00".to_string(),
        }
    }
}
